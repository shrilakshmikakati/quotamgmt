...
export type DecrementInput<TAccountQuotamgmt extends string = string> = {
...
>(
  input: DecrementInput<TAccountQuotamgmt>,
  config?: { programAddress?: TProgramAddress }
): DecrementInstruction<TProgramAddress, TAccountQuotamgmt> {
  // Program address.
  ...
  const instruction = {
    accounts: [getAccountMeta(accounts.quotamgmt)],
    programAddress,
    data: getDecrementInstructionDataEncoder().encode({}),
  } as DecrementInstruction<TProgramAddress, TAccountQuotamgmt>;
